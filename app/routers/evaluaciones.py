...
from app.models.respuesta_evaluacion import (
    RespuestaEvaluacion,
)
...
def obtener(
    ...
    return EvaluacionDetalleResponse(
        ...
        aspecto_positivo=
            evaluacion.aspecto_positivo,

        aspecto_por_mejorar=
            evaluacion.aspecto_por_mejorar,

        firma_s3_key=
            evaluacion.firma_s3_key,

        pdf_s3_key=
            evaluacion.pdf_s3_key,
...
# =========================================================
# LISTAR EVALUACIONES POR JURADO
# =========================================================
